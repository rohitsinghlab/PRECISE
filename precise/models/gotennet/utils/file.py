...
from precise.gotennet.utils.logging_utils import get_logger
...
def download_checkpoint(checkpoint_url: str) -> str:
    ...
    """
    from precise.gotennet.models.tasks import TASK_DICT
    ...
    if is_name_style:
        ...
        if task == "qm9":
            try:
                from precise.gotennet.datamodules.components.qm9 import qm9_target_dict
