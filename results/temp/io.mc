...
# Creation Date and Time:  Tue Nov 25 23:44:38 2025
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.067510e-01
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.113790e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 1.375219e+00
Vprtstp: iteration = 0
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.556492e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.135597e+00
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.568000e-03
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.248616
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.010576e+00
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.066310e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.178960e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 4.549130e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.547237e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.132003e+00
Vpmg_setPart:  lower corner = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  upper corner = (83.497, 65.513, 74.3145)
...
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.647000e-03
Vnm_tstart: starting timer 30 (Force timer)..
...
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 7.145525e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Tue Nov 25 23:44:46 2025
...
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Tue Nov 25 23:48:14 2025
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.250129
Vpmg_fillco:  done filling coefficient arrays
Vpmg_fillco:  filling boundary arrays
Vpmg_fillco:  done filling boundary arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 7.688940e-01
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.021220e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.094070e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 1.356895e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 4.659896e-07
Vprtstp: contraction number = 2.006387e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.577268e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.148246e+00
Vpmg_setPart:  lower corner = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  upper corner = (97.2137, 75.9036, 86.536)
Vpmg_setPart:  actual minima = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  actual maxima = (97.2137, 75.9036, 86.536)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 8.954660786116E+04 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.690000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 1.000000e-06
Vnm_tstart: starting timer 27 (Setup timer)..
Setting up PBE object...
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.248595
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.000615e+00
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.023140e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.138170e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 4.531462e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 6.605342e-07
Vprtstp: contraction number = 2.061140e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.596442e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.170712e+00
Vpmg_setPart:  lower corner = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  upper corner = (83.497, 65.513, 74.3145)
Vpmg_setPart:  actual minima = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  actual maxima = (83.497, 65.513, 74.3145)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 1.486605963327E+05 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.762000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 0.000000e+00
Vgrid_writeDX:  Opening virtual socket...
Vgrid_writeDX:  Writing to virtual socket...
...
printEnergy:  Performing global reduction (sum)
Vcom_reduce:  Not compiled with MPI, doing simple copy.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 7.238502e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Tue Nov 25 23:48:22 2025
...
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Wed Nov 26 21:26:08 2025
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.249869
Vpmg_fillco:  done filling coefficient arrays
Vpmg_fillco:  filling boundary arrays
Vpmg_fillco:  done filling boundary arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 7.667430e-01
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.069550e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.111180e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 1.361318e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 4.659896e-07
Vprtstp: contraction number = 2.006387e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.521396e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.099311e+00
Vpmg_setPart:  lower corner = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  upper corner = (97.2137, 75.9036, 86.536)
Vpmg_setPart:  actual minima = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  actual maxima = (97.2137, 75.9036, 86.536)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 8.954660786116E+04 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.569000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 1.000000e-06
Vnm_tstart: starting timer 27 (Setup timer)..
Setting up PBE object...
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.247911
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.007289e+00
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.063290e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.177580e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 4.494086e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 6.605342e-07
Vprtstp: contraction number = 2.061140e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.519823e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.101786e+00
Vpmg_setPart:  lower corner = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  upper corner = (83.497, 65.513, 74.3145)
Vpmg_setPart:  actual minima = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  actual maxima = (83.497, 65.513, 74.3145)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 1.486605963327E+05 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.546000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 0.000000e+00
Vgrid_writeDX:  Opening virtual socket...
Vgrid_writeDX:  Writing to virtual socket...
...
printEnergy:  Performing global reduction (sum)
Vcom_reduce:  Not compiled with MPI, doing simple copy.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 7.055182e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Wed Nov 26 21:26:16 2025
...
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Wed Nov 26 21:29:55 2025
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.250535
Vpmg_fillco:  done filling coefficient arrays
Vpmg_fillco:  filling boundary arrays
Vpmg_fillco:  done filling boundary arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 7.694620e-01
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.073390e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.134070e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 1.368002e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 4.659896e-07
Vprtstp: contraction number = 2.006387e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.576540e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.158110e+00
Vpmg_setPart:  lower corner = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  upper corner = (97.2137, 75.9036, 86.536)
Vpmg_setPart:  actual minima = (-17.9817, -23.1367, -21.397)
Vpmg_setPart:  actual maxima = (97.2137, 75.9036, 86.536)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 8.954660786116E+04 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.736000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 1.000000e-06
Vnm_tstart: starting timer 27 (Setup timer)..
Setting up PBE object...
...
Vpmg_fillco:  marking ion and solvent accessibility.
fillcoCoef:  Calling fillcoCoefMol...
Vacc_SASA: Time elapsed: 0.248267
Vpmg_fillco:  done filling coefficient arrays
Vnm_tstop: stopping timer 27 (Setup timer).  CPU TIME = 1.010191e+00
Vnm_tstart: starting timer 28 (Solver timer)..
Vnm_tstart: starting timer 30 (Vmgdrv2: fine problem setup)..
Vbuildops: Fine: (161, 161, 161)
Vbuildops: Operator stencil (lev, numdia) = (1, 4)
Vnm_tstop: stopping timer 30 (Vmgdrv2: fine problem setup).  CPU TIME = 1.068450e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: coarse problem setup)..
Vbuildops: Galer: (081, 081, 081)
Vbuildops: Galer: (041, 041, 041)
Vbuildops: Galer: (021, 021, 021)
Vnm_tstop: stopping timer 30 (Vmgdrv2: coarse problem setup).  CPU TIME = 4.191440e-01
Vnm_tstart: starting timer 30 (Vmgdrv2: solve)..
Vnm_tstop: stopping timer 40 (MG iteration).  CPU TIME = 4.562503e+00
Vprtstp: iteration = 0
Vprtstp: relative residual = 1.000000e+00
Vprtstp: contraction number = 1.000000e+00
Vprtstp: iteration = 1
...
Vprtstp: relative residual = 6.605342e-07
Vprtstp: contraction number = 2.061140e-01
Vnm_tstop: stopping timer 30 (Vmgdrv2: solve).  CPU TIME = 1.578163e+00
Vnm_tstop: stopping timer 28 (Solver timer).  CPU TIME = 2.163251e+00
Vpmg_setPart:  lower corner = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  upper corner = (83.497, 65.513, 74.3145)
Vpmg_setPart:  actual minima = (-4.265, -12.746, -9.1755)
Vpmg_setPart:  actual maxima = (83.497, 65.513, 74.3145)
...
Vpmg_qfEnergyVolume:  Calculating energy
Vpmg_energy:  qfEnergy = 1.486605963327E+05 kT
Vnm_tstop: stopping timer 29 (Energy timer).  CPU TIME = 5.699000e-03
Vnm_tstart: starting timer 30 (Force timer)..
Vnm_tstop: stopping timer 30 (Force timer).  CPU TIME = 1.000000e-06
Vgrid_writeDX:  Opening virtual socket...
Vgrid_writeDX:  Writing to virtual socket...
...
printEnergy:  Performing global reduction (sum)
Vcom_reduce:  Not compiled with MPI, doing simple copy.
Vnm_tstop: stopping timer 26 (APBS WALL CLOCK).  CPU TIME = 7.196839e+00
##############################################################################
# MC-shell I/O capture file.
# Creation Date and Time:  Wed Nov 26 21:30:03 2025
